      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="mt-6 sm:mt-8 md:mt-10 flex items-center justify-center">
          <a
            ...
            className="bg-white text-black rounded-2xl  font-semibold px-4 sm:px-6 py-2 sm:py-3 text-sm sm:text-base inline-flex items-center gap-2 sm:gap-3 shadow-sm hover:shadow-md transition shadow-black/10"
          >
